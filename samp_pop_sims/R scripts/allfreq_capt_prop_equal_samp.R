#Code written by XXX and XXX in collaboration
...
my_dir = "C:\\Users\\XXX\\Documents\\XXX-XXX\\samp_pop_sims\\Simulations"
setwd(my_dir)

###allelic capture functions 
source("C:\\Users\\XXX\\Documents\\XXX-XXX\\samp_pop_sims\\R scripts\\Fa_sample_funcs.R")
##functions
